...
import { Clock, ChevronLeft, LogIn, LogOut as LogOutIcon, Calendar, Home, Mail, Hash, Info, X } from '@tamagui/lucide-icons'
          ...
          {selectedRecord && (
            <YStack space="$4" paddingTop="$2">
              ...
              >
                ...
                <YStack flex={1} space="$1">
                  ...
                  <Text fontSize="$3" color="$gray11" fontWeight="600">
                    {selectedRecord.accessor_name || getUserName(selectedRecord.user_email)}
                  </Text>
                  <XStack space="$2" alignItems="center">
                    <Text fontSize="$2" color="$gray10">
              ...
              <YStack space="$3">
                ...
                {selectedRecord.accessor_type === 'user' && selectedRecord.user_email && (
                  <XStack space="$3" alignItems="center">
                    <Circle size={36} backgroundColor="$blue3">
                      <Mail size={18} color="$blue10" />
                    </Circle>
                    <YStack flex={1}>
                      <Text fontSize="$2" color="$gray11">
                        Usuario
